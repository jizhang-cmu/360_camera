Unzip the file on the computer. Follow the readme in 'src/receive_theta' to set up the Theta camera driver. Install the dependencies. Then, go to the ROS workspace ('360_camera' folder) and compile.
